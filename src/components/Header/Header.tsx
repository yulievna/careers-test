    ...
    <header className={s.header}>
      <div className={s.header__container}>
        <div className={s.header__logo}>
          <a href="/">
            <img src="/assets/images/logo.svg" alt="Figma" className={s.header__logoImage} />
          </a>
        </div>
        ...
        <div className={s.header__navContainer}>
          ...
          <div className={s.header__searchContainer}>
            <div
              className={`${s.header__searchInputWrapper} ${isSearchOpen ? s.header__searchInputWrapper_open : ''}`}
            >
              <input
                ref={searchInputRef}
                type="text"
