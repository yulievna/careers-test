            ...
            <div className={s.footer__container}>
                <div className={s.footer__main}>
                    ...
                    <nav className={s.footer__navList}>
                        <NavLink to="/about" className={s.footer__navItem}>О НАС</NavLink>
                        <NavLink to="/assets" className={s.footer__navItem}>АКТИВЫ</NavLink>
                        <NavLink to="/media" className={s.footer__navItem}>МЕДИА</NavLink>
                        <NavLink to="/careers" className={s.footer__navItem}>КАРЬЕРА</NavLink>
                        <NavLink to="/investors" className={s.footer__navItem}>ИНВЕСТОРАМ</NavLink>
                        <NavLink to="/suppliers" className={s.footer__navItem}>ПОСТАВЩИКАМ</NavLink>
                        <NavLink to="/contacts" className={s.footer__navItem}>КОНТАКТЫ</NavLink>
                    </nav>
